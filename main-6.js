...
},
{
    ...
    let man6FullCopy  = {...man6, mother: {...man6.mother, work:{...man6.mother.work}, parents:[...man6.mother.parents.map(el => ({el, favotiteDish: {...el.favoriteDish}}))]}}
...
{title: "rise", amount: 0.5}
    ...
    let man7FullCopy  =  {...man7, mother: {...man7.mother, work:{...man7.mother.work}, parents:[...man7.mother.parents.map(el => ({...el, favoriteDish: {...el.favoriteDish, ingredients: [...el.favoriteDish.ingredients.map(el => ({...el}))]}}))]}}
